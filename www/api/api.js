...
tink_web_routing_Router0.prototype = {
	...
	,hello: function(ctx,name) {
		...
		return tink_core__$Promise_Promise_$Impl_$.next(new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(d.hello(d1)))),tink_core__$Promise_Next_$Impl_$.ofSafeSync(function(v1) {
